...
import { SIZES, type Customer } from "@/data/types";
 ...
 */
export function renderSeedSql(input: CatalogInput, customers: Customer[]): string {
  const parts: string[] = [];
...
if (process.argv[1] !== undefined && pathToFileURL(process.argv[1]).href === import.meta.url) {
  writeFileSync(SEED_PATH, renderSeedSql(fixtureInput(), fixtureCustomers()), "utf8");
