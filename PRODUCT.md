...
**Ràng buộc kỹ thuật:**
- Backend (từ 23/09/2026, QĐ-25): Supabase Postgres + Auth, đọc qua Server Components và ghi qua Server Actions; **trình duyệt không gọi Supabase**. `data/types.ts` vẫn là hợp đồng dữ liệu; `data/*.ts` là fixture cho test và nguồn sinh seed. Thanh toán: chuyển khoản đối chiếu tay + COD; không cổng thanh toán.
...
**Từ vựng chốt trong sản phẩm:** *drop* (đợt mở bán), *lô* (số thứ tự drop), *size* (S/M/L/XL và số), *form* (oversize / regular), *còn hàng / hết size / đã đóng drop*.

## Brand Commitments

**Không có cam kết nào. Thiết kế đang hoàn toàn tự do.**

Trong một phiên trước, người dùng có nêu một hướng thẩm mỹ và bản dựng theo hướng
đó **đã bị bác bỏ và xoá sạch**. Hướng ấy **không còn hiệu lực**: nó không phải
ràng buộc, không phải điểm xuất phát, và không được dùng làm tham chiếu — kể cả
làm thứ để né tránh. Vòng thiết kế sau bắt đầu từ con số không.

Chưa có: tên thương hiệu, logo, bảng màu, font, tone giọng, hay bất kỳ tài sản
thương hiệu nào. Người dùng có nói tên để chung chung cũng được, nhưng chưa chốt.
